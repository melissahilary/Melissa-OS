...
export default function Haircare({ subPage, cycleConfig }) {
  if (subPage === 'routine') return <RoutineBuilder storeKey="mos:haircare:routine" Icon={Sparkles} intro="Wash day and every day — each step carries its product, type and cadence." types={HAIR_TYPES} />
