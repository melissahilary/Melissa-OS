...
export default function FitnessPlan() {
  ...
  const remove = (id) => { setPlan((p) => (Array.isArray(p) ? p : []).filter((w) => w.id !== id)); setOpenId(null) }
        ...
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center" role="dialog" aria-modal="true">
          ...
          <div className="relative w-full max-w-md rounded-t-3xl border border-stone-200 bg-cream shadow-2xl sm:rounded-3xl">
            <div className="flex items-center justify-between px-6 pb-1 pt-5">
              ...
              <button onClick={() => setOpenId(null)} aria-label="Close" className="text-stone-400 hover:text-stone-900"><X size={18} /></button>
            </div>
